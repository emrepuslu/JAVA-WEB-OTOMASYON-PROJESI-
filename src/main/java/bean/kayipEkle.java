 ...
 * @author EPUSLU
 */
@ManagedBean(name="kayipEkle")
@RequestScoped
public class kayipEkle {
    ...
    public String ekle(){
        ...
        try{
            ...
            ps=con.prepareStatement("INSERT INTO kayip(resim, ad, soyad, uyruk, hakkinda, yas, cinsiyet, gozRengi, sacRengi) VALUES(?,?,?,?,?,?,?,?,?)");
